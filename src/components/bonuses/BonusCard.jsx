...
import { CheckCircle2, XCircle, Clock, Award, User, Calendar } from "lucide-react";
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">
              Contract ended {bonus.contract_end_date} · {bonus.min_contract_months}mo minimum term
            </p>
          </div>
        </div>
