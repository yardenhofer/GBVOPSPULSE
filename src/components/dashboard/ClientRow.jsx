...
export default function ClientRow({ client, flags, status, isOwn, onClick, instantlyResult, sortBy }) {
  ...
  return (
    ...
    >
      ...
      <div className="px-4 py-5 grid grid-cols-[1fr_auto] gap-2 lg:grid-cols-[minmax(220px,1.5fr)_90px_120px_80px_100px_90px_90px_90px_auto] lg:gap-4 items-center">
        {/* Name + AM */}
        <div className="min-w-0">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 truncate">
            ...
            {(sortBy === "revenue_desc" || sortBy === "revenue_asc") && (
              <span className="ml-1.5 text-[10px] font-bold text-green-500 bg-green-500/10 px-1.5 py-0.5 rounded-full">
        ...
        {/* Sentiment */}
        <div className={`hidden lg:inline-flex items-center self-center gap-1 text-xs font-medium px-2 py-0.5 rounded-full ${sentCfg.bg} ${sentCfg.color}`}>
